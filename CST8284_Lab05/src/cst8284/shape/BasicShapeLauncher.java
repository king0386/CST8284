...
public class BasicShapeLauncher {
	...
	public static void main(String[] args){
	    ...
	    //My own rectangle subclass
//	    Rectangle rectangle = new Rectangle(2.0, 2.0);
//	    System.out.println(rectangle.toString());
//	    System.out.printf("The circumference of the square is %.3f", rectangle.getPerimeter());
//	    System.out.printf(" and its area is %.3f ", rectangle.getArea());
//	    System.out.printf(" and it's height is %.3f \n\n", rectangle.getHeight());
//	    Rectangle rectangle1 = new Rectangle();
//	    System.out.println("My Rectangle and Square are " + (rectangle1.equals(square) ? "" :"NOT ") + "equal");
